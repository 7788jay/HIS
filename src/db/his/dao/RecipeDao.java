...
public class RecipeDao {
    ...
    public void insert(Recipe r, List<Recipe_Treatment> rts) throws SQLException {
        String sql = "insert into recipe (recipe_id,doctor_id,diag_date,patient_id,comment)values(?,?,?,?,?) ";
        Object [] params = new Object[]{r.getRecipe_id(),r.getDoctor_id(),r.getDiag_date(),r.getPatient_id(),r.getComment()};
